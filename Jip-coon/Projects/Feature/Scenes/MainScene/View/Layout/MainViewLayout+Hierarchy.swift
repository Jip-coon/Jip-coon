...
extension MainViewLayout {
    ...
    internal func setupContentHierarchy() {
        ...
        components.myTasksSectionView.addSubview(components.myTasksCollectionView)
        ...
        components.statsSectionView.addSubview(components.categoryStatsCollectionView)
        ...
        components.quickActionsSectionView.addSubview(components.quickActionsCollectionView)
        ...
        components.recentActivitySectionView.addSubview(components.recentActivityCollectionView)
