...
public extension UIColor {
    ...
    static let blue2 = UIColor(named: "blue2", in: .module, compatibleWith: nil)!
    ...
    static let yellow1 = UIColor(named: "yellow1", in: .module, compatibleWith: nil)!
    static let brown1 = UIColor(named: "brown1", in: .module, compatibleWith: nil)!
